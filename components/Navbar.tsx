...
const Navbar: React.FC<NavbarProps> = ({ 
  activeTab, onTabChange, onUpload, onAddMember, onExport, onDownloadSample, onReset, isDarkMode, toggleTheme, isSaved = true
}) => {
    ...
    <nav className="no-print sticky top-0 z-50 glass border-b border-amber-500/10 px-6 py-4 shadow-xl shadow-black/40">
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          {onReset && (
            <button onClick={onReset} className="p-2.5 text-red-500/30 hover:text-red-500 transition-colors" title="Làm mới toàn bộ dữ liệu">
